...
try:
    os.system(
        "rm /home/valiokei/Documenti/GitHub/nelder-mead/Crazyflie/Lib_Originale_Matteo/*_ORIG.csv")
    os.system(
        "rm /home/valiokei/Documenti/GitHub/nelder-mead/Crazyflie/Lib_Originale_Matteo/main_ORIG")
except:
    pass


os.system("/usr/bin/gcc -fdiagnostics-color=always -g /home/valiokei/Documenti/GitHub/nelder-mead/Crazyflie/Lib_Originale_Matteo/*_ORIG.c /home/valiokei/Documenti/GitHub/nelder-mead/Crazyflie/Lib_Originale_Matteo/*_ORIG.h -o /home/valiokei/Documenti/GitHub/nelder-mead/Crazyflie/Lib_Originale_Matteo/main_ORIG -lm -I /home/valiokei/Documenti/GitHub/nelder-mead/Lib_Originale_Matteo/")

os.system(
    "cd /home/valiokei/Documenti/GitHub/nelder-mead/Crazyflie/Lib_Originale_Matteo/ && ./main_ORIG")


# Load CSV files into Pandas DataFrame
df_Anchors = pd.read_csv('Anchors_ORIG.csv', header=0)
df_EstimatedTagPositions = pd.read_csv(
    'EstimatedTagPositions_ORIG.csv', header=0)
df_TrueTagPositions = pd.read_csv('TrueTagPositions_ORIG.csv', header=0)

# add also the inputPoint File with the same format
df_inputPoint = pd.read_csv('InputPoint_ORIG.csv', header=0)
